...
//	private FileInputStream in;
	...
	@Override
	public double calculScore(Object d, Object c, Object a) {

		int[] depart = null;
		int[] courant = null;
		int[] arrivee = null;
		try {
			depart = objectToCoords(d);
		...
		double scoreDepCour =  Math.sqrt(((courant[0] - depart[0])*(courant[0] - depart[0]))
				+ 
				   ((courant[1] - depart[1])*(courant[1] - depart[1]))
		);
